...
object DataSourceModule {
    @Provides
    fun provideHeadlinesDataSource(newsApi: NewsApi): NewsDataSource = HeadlinesDataSource(newsApi)

    @Provides
    fun provideNewsDbDataSource(dao: NewsDao): NewsDataSource = NewsDbDataSource(dao)
}