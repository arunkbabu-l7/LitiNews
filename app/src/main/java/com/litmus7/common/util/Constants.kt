...
object Constants {
    ...
    const val NEWS_PUBLISHED_AT_KEY = "key_news_published_at"
    const val NEWS_SOURCE_ID_KEY = "key_news_source_id"
    const val NEWS_SOURCE_NAME_KEY = "key_news_source_name"
    ...
    const val ERROR_METHOD_NOT_IMPLEMENTED = "Method not implemented"
}
